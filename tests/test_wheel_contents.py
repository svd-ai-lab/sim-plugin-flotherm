...
def test_wheel_contains_skills(tmp_path: Path) -> None:
    ...
    wheels = list(out_dir.glob("sim_plugin_flotherm-*.whl"))
    ...
    required = {
        "sim_plugin_flotherm/__init__.py",
        "sim_plugin_flotherm/driver.py",
        "sim_plugin_flotherm/_skills/flotherm/SKILL.md",
    }
